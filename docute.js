! function(e, t) { "object" === typeof exports && "object" === typeof module ? module.exports = t() : "function" === typeof define && define.amd ? define([], t) : "object" === typeof exports ? exports.Docute = t() : e.Docute = t() }(this, (function() {
    return function(e) {
        ...
        (function(e, n) {
            ...
            function Re(e, t, n, r) { var i = Object.create(e || null); return t ? T(i, t) : i }
            je.data = function(e, t, n) { return n ? Fe(e, t, n) : t && "function" !== typeof t ? e : Fe(e, t) }, D.forEach((function(e) { je[e] = Me })), z.forEach((function(e) { je[e + "s"] = Re })), je.watch = function(e, t, n, r) {
            ...
            function qe(e, t, n) {
                if (H.errorHandler) try { return H.errorHandler.call(null, e, t, n) } catch (hs) { hs !== e && Ve(hs, null, "config.errorHandler") }
                Ve(e, t, n)
            }
                    ...
                    for (var n = Object.create(null), r = le ? Reflect.ownKeys(e) : Object.keys(e), i = 0; i < r.length; i++) {
                        ...
                        if ("__ob__" !== o) {
                            for (var a = e[o].from, s = t; s;) {
                                if (s._provided && k(s._provided, a)) { n[o] = s._provided[a]; break }
                                s = s.$parent
                            }
                            if (!s)
                                if ("default" in e[o]) {
            ...
            function Rt(e, t) { for (var n in t) e[C(n)] = t[n] }
            It(Ft.prototype);
            var Pt = {
                    init: function(e, t) {
                ...
                if (e.attrs && (n += "attrs:" + ts(e.attrs) + ","), e.props && (n += "domProps:" + ts(e.props) + ","), e.events && (n += Na(e.events, !1) + ","), e.nativeEvents && (n += Na(e.nativeEvents, !0) + ","), e.slotTarget && !e.slotScope && (n += "slot:" + e.slotTarget + ","), e.scopedSlots && (n += function(e, t, n) {
                        ...
                        if (!r)
                            for (var o = e.parent; o;) {
                                if (o.slotScope && o.slotScope !== da || o.for) { r = !0; break }
                                o.if && (i = !0), o = o.parent
                            }
            ...
            function ns(e) { return e.replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029") }
        ...
        function n(e, t) { var r = { name: e.name, path: e.path, hash: e.hash, query: e.query, params: e.params, fullPath: e.fullPath, meta: e.meta }; return t && (r.from = n(t)), Object.freeze(r) }
        ...
        function _(e) { this.tokens = [], this.tokens.links = Object.create(null), this.options = e || R.defaults, this.rules = b.normal, this.options.pedantic ? this.rules = b.pedantic : this.options.gfm && (this.options.tables ? this.rules = b.tables : this.rules = b.gfm) }
        ...
        function E(e, t) { return T[" " + e] || (/^[^:]+:\/*[^/]*$/.test(e) ? T[" " + e] = e + "/" : T[" " + e] = M(e, "/", !0)), e = T[" " + e], "//" === t.slice(0, 2) ? e.replace(/:[\s\S]*/, ":") + t : "/" === t.charAt(0) ? e.replace(/(:\/*[^/]*)[\s\S]*/, "$1") + t : e + t }
        k._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g, k._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, k._email = /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/, k.autolink = O(k.autolink).replace("scheme", k._scheme).replace("email", k._email).getRegex(), k._attribute = /\s+[a-zA-Z@:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, k.tag = O(k.tag).replace("comment", b._comment).replace("attribute", k._attribute).getRegex(), k._label = /(?:\[[^\[\]]*\]|\\[\[\]]?|`[^`]*`|[^\[\]\\])*?/, k._href = /\s*(<(?:\\[<>]?|[^\s<>\\])*>|(?:\\[()]?|\([^\s\x00-\x1f\\]*\)|[^\s\x00-\x1f()\\])*?)/, k._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, k.link = O(k.link).replace("label", k._label).replace("href", k._href).replace("title", k._title).getRegex(), k.reflink = O(k.reflink).replace("label", k._label).getRegex(), k.normal = I({}, k), k.pedantic = I({}, k.normal, { strong: /^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/, em: /^_(?=\S)([\s\S]*?\S)_(?!_)|^\*(?=\S)([\s\S]*?\S)\*(?!\*)/, link: O(/^!?\[(label)\]\((.*?)\)/).replace("label", k._label).getRegex(), reflink: O(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", k._label).getRegex() }), k.gfm = I({}, k.normal, { escape: O(k.escape).replace("])", "~|])").getRegex(), _extended_email: /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/, url: /^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/, _backpedal: /(?:[^?!.,:;*_~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_~)]+(?!$))+/, del: /^~+(?=\S)([\s\S]*?\S)~+/, text: O(k.text).replace("]|", "~]|").replace("|$", "|https?://|ftp://|www\\.|[a-zA-Z0-9.!#$%&'*+/=?^_`{\\|}~-]+@|$").getRegex() }), k.gfm.url = O(k.gfm.url).replace("email", k.gfm._extended_email).getRegex(), k.breaks = I({}, k.gfm, { br: O(k.br).replace("{2,}", "*").getRegex(), text: O(k.gfm.text).replace("{2,}", "*").getRegex() }), w.rules = k, w.output = function(e, t, n) { return new w(t, n).output(e) }, w.prototype.output = function(e) {
            for (var t, n, r, i, o, a, s = ""; e;)
                ...
                if (o = this.rules.tag.exec(e)) !this.inLink && /^<a /i.test(o[0]) ? this.inLink = !0 : this.inLink && /^<\/a>/i.test(o[0]) && (this.inLink = !1), !this.inRawBlock && /^<(pre|code|kbd|script)(\s|>)/i.test(o[0]) ? this.inRawBlock = !0 : this.inRawBlock && /^<\/(pre|code|kbd|script)(\s|>)/i.test(o[0]) && (this.inRawBlock = !1), e = e.substring(o[0].length), s += this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(o[0]) : $(o[0]) : o[0];
                    ...
                    if (e = e.substring(o[0].length), t = (o[2] || o[1]).replace(/\s+/g, " "), !(t = this.links[t.toLowerCase()]) || !t.href) { s += o[0].charAt(0), e = o[0].substring(1) + e; continue }
            ...
            if (this.options.sanitize) { try { var r = decodeURIComponent(S(e)).replace(/[^\w:]/g, "").toLowerCase() } catch (c) { return n } if (0 === r.indexOf("javascript:") || 0 === r.indexOf("vbscript:") || 0 === r.indexOf("data:")) return n }
        ...
        function R(e, t, n) {
            ...
            if (n || "function" === typeof t) {
                ...
                var r, i, o = (t = I({}, R.defaults, t || {})).highlight,
                    a = 0;
                try { r = _.lex(e, t) } catch (c) { return n(c) }
                i = r.length;
        ...
        function Y(e, t, n) { return n ? t ? t(e) : e : (e && e.then || (e = Promise.resolve(e)), t ? e.then(t) : e) }
        r.a.use(m.a);
        ...
        function Ct(e, t) { if (t) return function() { return e.apply(t, arguments) } }
        wt.prototype.listen = function(e) { this.cb = e }, wt.prototype.onReady = function(e, t) { this.ready ? e() : (this.readyCbs.push(e), t && this.readyErrorCbs.push(t)) }, wt.prototype.onError = function(e) { this.errorCbs.push(e) }, wt.prototype.transitionTo = function(e, t, n) {
            var r = this,
                        ...
                        methods: {
                            ...
                            linkPrefetch: function() {
                                ...
                                if (!e.meta.__prefetched) {
                                    ...
                                    if (i.length > 0)
                                        for (var o = 0, a = i; o < a.length; o += 1) { qt(a[o]) }
                                    this.unobserve()
                                }
                            }
                        }
        ...
        function Kn(e, t, n, r) {
            ...
            function c() {
                ...
                function f() { a = Date.now(), n.apply(c, l) }
                o || (r && !i && f(), s(), void 0 === r && u > e ? f() : !0 !== t && (i = setTimeout(r ? function() { i = void 0 } : f, void 0 === r ? e - u : e)))
            }
